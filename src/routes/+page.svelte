...
<div class="hero py-10">
	<div class="hero-content text-center">
		<div class="max-w-5xl">
			...
			<div class="alert bg-info text-info-content mb-6">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					class="h-5 w-5"
					fill="none"
				...
				<span>Configure the active map pool used for team statistics.</span>
				<div class="ml-auto">
					<a href={`${base}/config`} class="btn btn-sm">Configure Maps</a>
				</div>
			</div>
