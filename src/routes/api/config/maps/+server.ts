...
// For simplicity, we'll use a file-based approach or in-memory
...
// Export function to get current config (for use in other server code)
export function getCurrentMapPool(): string[] {
